...
async function setup() {
  ...
  if (!connectionString) {
    console.error("[setup] DATABASE_URL is not set in .env");
    process.exit(1);
  }

  console.log("[setup] Connecting to Supabase PostgreSQL...");
  const client = postgres(connectionString, { max: 1 });

  try {
    console.log("[setup] Running SQL migration (DROP + CREATE)...");
    ...
    console.log("[setup] Seeding subjects...");
    ...
    console.log("[setup] Seeding deadlines...");
    ...
    console.log("[setup] Seeding opportunities...");
    ...
    console.log("[setup] Seeding resources...");
    ...
    console.log("[setup] Seeding student profile...");
    ...
    console.log("[setup] Seeding college events...");
    ...
    console.log("[setup] Seeding health data...");
    ...
    console.log("[setup] Seeding health activities...");
    ...
    console.log("[setup] Seeding wallet balance...");
    ...
    console.log("[setup] Seeding wallet transactions...");
